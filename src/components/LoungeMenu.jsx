      ...
      <div className="lounge-root">
        <div className="lounge-content" style={{ paddingTop: "80px" }}>
          ...
          <motion.div variants={headerVariants} initial="hidden" animate="visible"
            style={{ padding: "28px 28px 28px", textAlign: "center" }}>
            <motion.div
          ...
          <motion.div variants={tabsVariants} initial="hidden" animate="visible"
            style={{ display: "flex", gap: "8px", overflowX: "auto", padding: "0 24px 20px", scrollbarWidth: "none", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.2, duration: 0.8 }}
            style={{ borderTop: "1px solid #1a1a1a", padding: "24px 28px 40px", textAlign: "center" }}>
            <GoldOrnament />
